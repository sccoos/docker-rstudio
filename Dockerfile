...
#
RUN echo "*/5 * * * * Rscript ~/AutoShoreStation/pH/GetConvertedpHData.R" > /etc/cron.daily/NB-pH
RUN echo "*/5 * * * * Rscript ~/Agua-Hedionda/ScrapeGoogleSheet.R" > /etc/cron.daily/SeapHOx
